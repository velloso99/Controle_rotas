...
def painel():
    ...
    #################---------BOTÕES------##################################################################################
    bt_ml = Button(frame_botao, command=ml_rota, text="Mercado Livre", bd=9, bg=co1, fg=co6, font=('verdana', 9, 'bold'))
    ...
    bt_euenttrego = Button(frame_botao, command=ee_rota, text="Eu Entrego", bd=9, bg=co1, fg=co6, font=('verdana', 9, 'bold'))
